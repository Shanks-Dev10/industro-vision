...
import chemicalImg from "@/assets/service-chemical.jpg";
import workProcessImg from "@/assets/work-process.jpg";
              ...
              <div key={s.num}>
                ...
                >
                  <img
                    src={s.image}
                    alt={s.title}
                    className="h-20 w-20 shrink-0 rounded-2xl object-cover transition-transform duration-300 group-hover:scale-105"
                    loading="lazy"
                  />
