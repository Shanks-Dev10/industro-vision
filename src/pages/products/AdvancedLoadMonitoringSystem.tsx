...
const AsymmetricLoadMeasuringSystem = () => {
  const ProductDetails = {
    ...
    description2:
      "In order to overcome the problems of overloading and unevenly loaded wagons, Railmet has developed the Asymmetric Load Measuring System (ALMS). ALMS is an intelligent railway monitoring system that is placed on the rail track and measures the wheel loads as the train passes over it. It provides accurate and real-time information on the wheel loads through its precision sensors and wheel detection technology. It provides accurate information on the wheel loads as the train passes over the track.",
    description3:
      "The implementation of Railmet’s Asymmetric Load Measuring System (ALMS) increases railway safety and efficiency by providing accurate and timely wagon load monitoring results. Railway operators are alerted to overloaded or unevenly loaded wagons by detecting these wagons as they cross the railway tracks, thus acting in time to avoid any damage to the railway infrastructure. The implementation of ALMS reduces excessive stress on railway tracks, thus minimizing costs associated with maintaining and extending the lifespan of railway infrastructure.",
  ...
  return (
    <div>
      <Header />
      <HeroBanner title={"Asymmetric Load Measuring System"} />
      <HeadingSection heading={"ALMS (Asymmetric Load Measuring System)"} />
      <ProductDetail
