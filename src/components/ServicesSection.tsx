      ...
      <div className="max-w-full 2xl:max-w-screen-xl mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col  mb-20 ">
          <div className="flex md:flex-row flex-col justify-between items-start md:items-center py-5 border-b-[1px] border-[#e0e4eb]">
            ...
            <p  className="text-xs uppercase tracking-widest text-gray-400 mb-3">[ our solutions ]</p>
          </div>

          <div className="flex flex-col md:flex-row gap-6 pt-4">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-7xl font-semibold text-black flex items-end gap-2">
                Services
                <span className="w-2 h-2 bg-[#FBE87E] rounded-full"></span>
              </h2>
            </div>
            <div className="md:max-w-lg max-w-full mx-auto">
              <p className="text-gray-600 mb-6 border-l-[4px] p-0 md:p-4 md:pl-7 border-transparent md:border-[#FBE87E]">
              ...
              <button className="flex items-center gap-3 bg-[#FBE87E] px-6 py-3 rounded-full font-semibold ml-7">
                All Services
