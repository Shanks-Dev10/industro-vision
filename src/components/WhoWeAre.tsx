            ...
            <div className="max-w-full 2xl:max-w-screen-xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-[1fr_1.2fr_1fr] gap-12 items-center">
                    ...
                    <div>
                        ...
                        <button className="flex items-center gap-4 bg-[#FBE87E] px-6 py-3 rounded-full font-semibold hover:bg-yellow-300 transition hover:bg-[#0B2B3F] hover:text-white">
                            Explore now
